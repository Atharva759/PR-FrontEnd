...
const TenantManagement = () => {
  ...
  const handleUpdateTenant = async () => {
    try {
      ...
      setTenants((prev) =>
        prev.map((t) => (t.id === editTenant ? { ...t, name: editName } : t)),
      );
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <h2 className="text-xl font-semibold mb-4">Existing Tenants</h2>

          {tenants.length === 0 ? (
            <p className="text-gray-500 text-center">No tenants created yet</p>
          ) : (
